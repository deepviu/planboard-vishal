...
const National = () => {
  ...
  return (
    <div className=" main ">
      ...
      <div id="Wgt_Zone_Id" class=" w3-leftbar w3-border-red Wgt_Zone_Class w3-row w3-row-padding w3-margin-bottom w3-white w3-round-large boxing">
      ...
      <div id="Wgt_Segment_Id" class="Wgt_Segment_Class w3-row w3-row-padding  w3-padding-large w3-margin-bottom w3-white w3-round-large boxing">
      ...
      <div id="Wgt_State_Id" class="Wgt_State_Class w3-row w3-row-padding w3-margin-bottom w3-white w3-round-large boxing">
